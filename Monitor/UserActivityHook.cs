...
namespace Monitor
{
    public class UserActivityHook
    {
        ...
        /// 结束按键时发生
        /// </summary>
        public event MouseEventHandler OverKeyUp;
        /// <summary>
        /// 鼠标左键双击
        /// </summary>
        ...
        /// 鼠标右键双击
        /// </summary>
        public event MouseEventHandler OnMouseRight;
        ...
        public void MouseEventHandler(object sender, MouseEventArgs e)
        {
            ...
            if (LastDate != null && LastDate.AddSeconds(1) > DateTime.Now)
            {
        ...
        public void MouseKeyMsg(object sender, MouseEventArgs e)
        {
            IsFirstKeyUp = true;
            //if (OverKeyUp != null)
            //{
